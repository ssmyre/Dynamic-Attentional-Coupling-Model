...
from MMT.modules.position_embedding import SinusoidalPositionalEmbedding
from MMT.modules.multihead_attention import MultiheadAttention
import math
...
class TransformerEncoder(nn.Module):
    ...
    def get_attention_maps(self, x, x_k=None, x_v=None, mask=None):
        attention_maps = []

        for layer in self.layers:
            _, attn_map = layer.self_attn(x, x_k, x_v, attn_mask=mask)
...
## Position-wise Feed-Forward from Paper 
